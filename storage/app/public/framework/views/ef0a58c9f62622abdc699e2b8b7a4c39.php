        ...
        <div class="campaign-banner">
            <div class="row align-items-center">
                ...
                <div class="col-md-7 order-1 order-lg-2 ps-lg-5">
                    <h2 class="section-title mt-4 text-start"><?php echo e($cbTitle); ?></h2>
                    <h6 class="mt-2 mb-3 text-end" style="font-size:15px;font-weight:600;color:var(--main-color)"><?php echo e($cbSubtitle); ?></h6>
                    <p class="color-67 text-start" style="font-size:14px;line-height:1.9"><?php echo e($cbDesc); ?></p>
                ...
                <div class="campaign-card h-100">
                    ...
                    <div class="campaign-card-body p-3">
                        ...
                        <div class="d-flex justify-content-between text-muted mb-3" style="font-size:13px">
                            <div class="text-center"><div class="fw-bold main-color">$<?php echo e(number_format($pRaised)); ?></div><div><?php echo e($locale==='ar'?'تم جمعه':'Raised'); ?></div></div>
...
<section class="main-section why-donate">
    <div class="container">
        <div class="header text-end" dir="rtl">
            <h6><?php echo e($locale==='ar'?'لماذا تتبرع لنا؟':'Why donate to us?'); ?></h6>
            <h2 class="section-title"><?php echo e($locale==='ar'?'لأننا نهتم بالحالات الأكثر احتياجًا.':'Because we care about those in greatest need.'); ?></h2>
        </div>
        <div class="row mt-5">
        ...
        <div class="stats-card">
            ...
            <div class="stats mt-5">
                <div class="row">
                    ...
                    <div class="col-md-4"><div class="stat w-100 mb-3"><span><?php echo e($locale==='ar'?'المبلغ المُجمَّع':'Raised'); ?></span><span>$<?php echo e(number_format($totalRaised)); ?></span></div></div>
...
<section class="main-section">
    <div class="container">
        <p class="color-67 text-center"><i class="fa-solid fa-handshake main-color me-2"></i><?php echo e($locale==='ar'?'الشركاء':'Partners'); ?></p>
        ...
        <p class="color-67 text-center mb-5"><?php echo e($locale==='ar'?'هل ستنقذ روحًا؟':'Will you save a soul?'); ?> <a href="<?php echo e(url($locale.'/donate')); ?>" class="main-color fw-bold"><?php echo e($locale==='ar'?'تبرع الآن':'Donate Now'); ?></a></p>
            ...
            <div class="col-lg-3 col-md-4 col-6">
                <div class="partner-card text-center p-4" style="background:<?php echo e($pColor); ?>;border-radius:16px;border:1px solid rgba(0,0,0,0.06)">
                    ...
                    <div style="width:60px;height:60px;border-radius:50%;background:white;display:flex;align-items:center;justify-content:center;margin:0 auto 12px;box-shadow:0 2px 8px rgba(0,0,0,0.1)">
                        <i class="fa-solid <?php echo e($pIcon); ?> fa-lg main-color"></i>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
